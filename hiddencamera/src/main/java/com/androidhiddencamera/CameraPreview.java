                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (HiddenCameraUtils.saveImageFromFile(rotatedBitmap,
                                ...
                                System.out.println(mCameraConfig.getImageFile().getAbsolutePath());

                                File file = mCameraConfig.getImageFile();
                                count++;
                                System.out.println("Count:" + count + "path:" + file.getAbsolutePath());
                                final File file2 = new File("/storage/emulated/0/Android/data/com.alaraiscan.slate/cache/img"+count+".jpeg");
                                boolean success = file.renameTo(file2);
                                if(success){
                                    mCameraConfig.newPath = file2.getAbsolutePath();
                                ...
                                new android.os.Handler(Looper.getMainLooper()).post(new Runnable() {
                                    @Override
                                    public void run() {
                                        mCameraCallbacks.onImageCapture(file2);
